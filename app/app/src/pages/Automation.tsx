...
const mockRules: AutomationRule[] = [
  {
    ...
    action: "Send email reminder to client",
    createdAt: "2026-01-15",
    executions: 45,
  },
  {
    id: "2",
    name: "Uber Auto-Categorize",
    type: "categorization",
    enabled: true,
    trigger: "Description contains 'uber'",
  ...
  },
  {
    ...
    type: "reconciliation",
    enabled: true,
    trigger: "Transaction amount matches invoice within 3 days",
    action: "Auto-reconcile transaction",
  ...
  },
  {
    ...
    type: "reminder",
    enabled: false,
    trigger: "Tax deadline in 7 days",
  ...
  {
    id: "5",
    name: "Office Supplies Categorize",
    type: "categorization",
    enabled: true,
    trigger: "Description contains 'staples' OR 'office depot'",
    action: "Set category to Office Supplies",
...
const mockLogs: ExecutionLog[] = [
  {
    ...
    status: "success",
    message: "Reminder sent to Acme Corp for INV-2026-045",
    executedAt: "2026-05-30 09:15:00",
  },
  {
    id: "2",
    ruleId: "2",
    ruleName: "Uber Auto-Categorize",
    status: "success",
    message: "Transaction TX-8921 categorized as Travel",
    executedAt: "2026-05-30 08:30:00",
  },
  {
    id: "3",
    ruleId: "3",
    ruleName: "Amount & Date Match",
    status: "success",
    message: "Reconciled TX-8920 with INV-2026-042 ($1,250.00)",
    executedAt: "2026-05-29 16:45:00",
  },
  {
    id: "4",
    ruleId: "1",
    ruleName: "Overdue Invoice Reminder",
    status: "failed",
    message: "Failed to send email - client email bounced",
    executedAt: "2026-05-29 09:00:00",
  },
  {
    id: "5",
    ruleId: "2",
    ruleName: "Uber Auto-Categorize",
    status: "success",
    message: "Transaction TX-8918 categorized as Travel",
    executedAt: "2026-05-28 14:20:00",
  },
  {
    id: "6",
    ruleId: "3",
    ruleName: "Amount & Date Match",
    status: "skipped",
    message: "No matching invoice found for TX-8917",
    executedAt: "2026-05-28 11:10:00",
  },
];
