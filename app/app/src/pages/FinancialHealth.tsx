...
export default function FinancialHealth() {
    ...
    return [
        ...
        ratios: [
          {
            ...
            benchmark: 1.5,
            unit: "x",
            status: getStatus(currentRatio, 1.5),
            description: "Ability to pay short-term obligations",
          },
          {
            name: "Quick Ratio",
            value: Math.round(quickRatio * 10) / 10,
            benchmark: 1.0,
            unit: "x",
            status: getStatus(quickRatio, 1.0),
            description: "Ability to pay without selling inventory",
          },
          {
            name: "Cash Ratio",
            ...
            benchmark: 0.5,
            unit: "x",
            status: getStatus(cashRatio, 0.5),
          ...
          },
          {
            ...
            benchmark: 200000,
            unit: "$",
            status: getStatus(workingCapital, 200000),
        ...
        ratios: [
          {
            ...
            benchmark: 1.0,
            unit: "x",
            status: getStatus(debtToEquity, 1.0, true),
          ...
          },
          {
            ...
            benchmark: 0.5,
            unit: "%",
            status: getStatus(debtRatio, 0.5, true),
          ...
          },
          {
            ...
            benchmark: 3.0,
            unit: "x",
            status: getStatus(interestCoverage, 3.0),
            description: "Ability to pay interest expenses",
          },
          {
            name: "Equity Ratio",
            value: Math.round(equityRatio * 100) / 100,
            benchmark: 0.5,
            unit: "%",
            status: getStatus(equityRatio, 0.5),
        ...
        ratios: [
          {
            ...
            benchmark: 5.0,
            unit: "%",
            status: getStatus(roa, 5.0),
            description: "Profit generated from assets",
          },
          {
          ...
          },
          {
            ...
            benchmark: 35.0,
            unit: "%",
            status: getStatus(grossMargin, 35.0),
          ...
          },
          {
            ...
            benchmark: 8.0,
            unit: "%",
            status: getStatus(netMargin, 8.0),
      ...
      },
      {
        ...
        ratios: [
          {
            name: "Asset Turnover",
            value: Math.round(assetTurnover * 100) / 100,
            benchmark: 0.5,
            unit: "x",
            status: getStatus(assetTurnover, 0.5),
          ...
          },
          {
            ...
            benchmark: 5.0,
            unit: "x",
            status: getStatus(inventoryTurnover, 5.0),
          ...
          },
          {
            ...
            benchmark: 6.0,
            unit: "x",
            status: getStatus(receivablesTurnover, 6.0),
          ...
          },
          {
            ...
            benchmark: 45.0,
            unit: "days",
            status: getStatus(dso, 45.0, true),
  ...
  // Historical health-score tracking requires stored snapshots over time,
  // which the backend does not persist yet, so we show no fabricated history.
  const HEALTH_TREND: {
    month: string;
    score: number;
    liquidity: number;
  ...
  const RADAR_DATA = useMemo(
    () => [
      ...
      {
        category: "Growth",
        score: Math.min(100, Math.round((categoryScores[2] + categoryScores[3]) / 2)),
        benchmark: 68,
      },
    ],
    [categoryScores],
          ...
          <CardContent>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {[
                ...
                {
                  label: "Profitability",
                  score: Math.min(100, categoryScores[2]),
                  icon: TrendingUp,
                  ...
                  <TableBody>
                    {category.ratios.map(ratio => {
                      const isLowerBetter =
                        ...
                        ratio.name === "Days Sales Outstanding";
            ...
            <Card>
              ...
              <CardContent>
                <div className="h-[300px] flex flex-col items-center justify-center text-center text-gray-500">
                  ...
                  <p className="text-sm">Score history will appear here as health snapshots accumulate over time.</p>
                </div>
              </CardContent>
            </Card>
          ) : (
                  ...
                  {INDUSTRY_BENCHMARKS.map(b => {
                    ...
                    return (
                      <TableRow key={b.ratio}>
                        ...
                        <TableCell>
                          <Badge
                            className={vsIndustry >= 0 ? "bg-green-100 text-green-800" : "bg-red-100 text-red-800"}
                          >
                            {vsIndustry >= 0 ? "+" : ""}
                            {vsIndustry.toFixed(0)}%
                          </Badge>
                        </TableCell>
                        <TableCell>
                ...
                {[
                  {
                    ...
                    description: `Your current ratio and quick ratio are derived from real balance sheet data. ${
                      categoryScores[0] >= 75
                        ? "Your short-term financial health is strong."
                        : "Consider improving your liquidity position."
                    }`,
                    icon: Activity,
                    color: "text-blue-600",
                    bgColor: "bg-blue-50",
                  },
                  {
                    ...
                    description: `Debt-to-equity ratio derived from your actual liabilities and equity. ${
                      categoryScores[1] >= 75 ? "Your leverage is conservative." : "Monitor your debt levels closely."
                    }`,
                    icon: Shield,
                  ...
                  },
                  {
                    ...
                    description: `ROA and ROE calculated from your actual P&L and balance sheet. ${
                      categoryScores[2] >= 70
                        ? "Your profitability is solid."
                  ...
                  },
                  {
                    ...
                    description: `Asset turnover and receivables collection based on your data. ${
                      categoryScores[3] >= 70
                        ? "Your efficiency metrics are healthy."
